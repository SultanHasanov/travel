document.addEventListener('DOMContentLoaded', function() {
  ...
  const openButton = document.getElementById('orders_booking'); // оставляем как есть
  const closeButton = document.querySelector('.modal__close');
  const form = document.getElementById('bookingForm');

  // Обработчик для статической кнопки (orders_booking)
  if (openButton) {
  ...
  // Обработчики для динамических кнопок (добавляются в renderToursForHome)
  // Они уже добавлены через addTourButtonHandlers()
